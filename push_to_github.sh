...
echo ""
echo "  1. Create a new Repl on the new account (any type)"
echo "  2. Open Shell and run:"
echo ""
echo "     git clone https://YOUR_TOKEN@github.com/$GITHUB_USER/$GITHUB_REPO.git /home/runner/workspace"
echo ""
echo "  3. Install Python packages:"
echo "     pip install flask flask-cors pyjwt werkzeug requests"
echo ""
echo "  4. Add Replit Secret: GITHUB_TOKEN + SESSION_SECRET"
echo ""
echo "  5. Create 2 workflows:"
echo "     Radd Hub       → cd radd-hub && python3 radd_hub.py run --skip-setup"
echo "     Watch Prototype → cd _watch_prototype && PORT=8000 python run.py"
echo ""
echo "  6. Read JAZZMAX_MASTER.md — continue from where you left off"
echo ""
echo "══════════════════════════════════════════════════════════════"
