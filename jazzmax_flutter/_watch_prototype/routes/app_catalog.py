...
def sync():
    ...
    for r in title_rows:
        ...
        titles.append({
            ...
            "runtime":       int(r["runtime"]) if r["runtime"] not in (None, "") else None,
            "season_count":  int(r["season_count"]) if r["season_count"] not in (None, "") else None,
            "episode_count": int(r["episode_count"]) if r["episode_count"] not in (None, "") else None,
